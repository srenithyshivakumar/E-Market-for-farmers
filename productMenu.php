		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
				...
				<?php
					...
					{
					 	$sql = "SELECT * FROM fproduct WHERE location ='$location'";
					}
				    if(isset($_GET['type']) AND $_GET['type'] == "fruit")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Fruit' and location ='$location'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "vegetable")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Vegetable' and location ='$location'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "grain")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Grains' location ='$location'";
					}
