...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Farmers App &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:Farmers App@gmail.com" style="color:white">demo@demo.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Farmers App</b></span>
				Farmers App is e-commerce trading platform for grains & grocerries...
			</p>
    ...
    <h3>Login</h3>
							<form method="post" action="Login/login.php">
								<div class="row uniform 50%">
									<div class="7u$">
										<input type="text" name="uname" id="uname" value="" placeholder="UserName / Kisan Id" style="width:80%" required/>
									</div>
									<div class="7u$">
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
									...
									<div class="3u 12u$(xsmall)">
										<input type="text" name="uname" id="uname" value="" placeholder="UserName / Kisan ID" required/>
									</div>
								</div>
								<div class="row uniform">
									<div class="3u 12u$(xsmall)">
								...
								<div class="row uniform">
									<div class="6u 12u$(xsmall)">
										<input type="text" name="city" id="city" value="" placeholder="State" style="width:80%" required/>
									</div>
								</div>
								<div class="row uniform">
									<div class="6u 12u$(xsmall)">
										<input type="text" name="addr" id="addr" value="" placeholder="City" style="width:80%" required/>
									</div>
								</div>
								<div class="row uniform">
									<p>
