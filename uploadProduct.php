<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
		...
		$sql = "INSERT INTO fproduct (fid, product, pcat, pinfo, price,location)
			   VALUES ('$fid', '$productName', '$productType', '$productInfo', '$productPrice','$location')";
